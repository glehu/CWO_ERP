...
class CwODB : IModule, Controller()
{
    ...
    ): Pair<Long, Int>
    {
        ...
        /* Since we are creating a new entry the entry's position in the database will be at the end
           ...
           We will index the entry in both the sub indices (e.g. ix1 to index the entry name) and the modules.mx.logic.main index
           The modules.mx.logic.main index will only contain the most basic data uniqueID, posInDatabase and byteSize
