...
class InvoiceProperty {
    ...
    val itemsProperty = observableListOf<InvoicePosition>()
    ...
    val statusTextProperty = SimpleStringProperty(InvoiceCLIController().getStatusText(0))
...
fun getInvoicePropertyFromInvoice(invoice: Invoice): InvoiceProperty {
    ...
    invoiceProperty.statusText = InvoiceCLIController().getStatusText(invoice.status)
...
fun getInvoiceFromInvoiceProperty(invoiceProperty: InvoiceProperty): Invoice {
    ...
    invoice.statusText = InvoiceCLIController().getStatusText(invoiceProperty.status)
